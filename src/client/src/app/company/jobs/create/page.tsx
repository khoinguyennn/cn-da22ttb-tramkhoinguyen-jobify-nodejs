...
export default function CreateJobPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showToast.success('Đăng bài tuyển dụng thành công!');
      router.push('/company/profile'); // Redirect to company profile
    } catch (error: any) {
      console.error('Error creating job:', error);
      showToast.error(error?.response?.data?.message || 'Có lỗi xảy ra khi đăng bài tuyển dụng');
    }
  };
        ...
        <div className="max-w-6xl mx-auto py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-semibold text-gray-900">Đăng bài tuyển dụng</h1>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="space-y-6">
          ...
          <div className="flex justify-center py-6">
            ...
            >
              {createJobMutation.isPending ? 'Đang đăng bài...' : 'Đăng bài'}
            </Button>
          </div>
        </div>
      </div>
